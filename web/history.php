  ...
  <div class="topnav" id="topnav">
    ...
    <div class="min-vh-10">
      <table id="example" class="table table-striped table-bordered">
        <thead>
          <tr>
            <th style='text-align: center' colspan='8' onclick="sortTable(0)"> History </th>
          </tr>
            <th onclick="sortTable(0)"> Order ID </th>
            <th onclick="sortTable(1)"> User </th>
            <th onclick="sortTable(2)">  Onigiri Ayam Suwir </th>
            <th onclick="sortTable(3)">  Onigiri Ikan Tongkol </th>
            <th onclick="sortTable(4)">  Onigiri Tuna Mayo </th>
            <th onclick="sortTable(5)">  Onigiri Rendang </th>
        ...
        <tbody>
          <!-- <tr>
            ...
            <td onclick=""> User </td>
            <td onclick="">  Onigiri Ayam Suwir </td>
            <td onclick="">  Onigiri Ikan Tongkol </td>
            <td onclick="">  Onigiri Tuna Mayo </td>
            <td onclick="">  Onigiri Rendang </td>
            <td onclick="">  Date Time </td>
            <td onclick="">  Total </td>
          </tr> -->
        </tbody>                             
      </table>
