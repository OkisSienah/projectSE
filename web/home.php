...
<html lang="en">
  ...
  <body>
    ...
    <div class="topnav" id="topnav">
      <nav>
        ...
        <ul class="menu">
          ...
          <li><a href="order.php" name="orderpage">Order Now</a></li>
    ...
    <div class="content-box">
      ...
      <div class="MenuOnigiri">
      <img src="../assets/bgMenu2.png" alt="">
      <div class="onigiri" id="onigiri1">
        <a href="TMAfterLogin.html"><img src="../assets/TunaMayo.png" alt=""></a>
        <div class="content" id="content1">
          <a href="TMAfterLogin.html"><div class="text" id="text1"> Tuna Mayo </div></a>
        </div>
      </div>
            
      <div class="onigiri" id="onigiri2">
        <a href="ITAfterLogin.html"><img src="../assets/IkanTongkol.png" alt=""></a>
        <div class="content" id="content2">
          <a href="ITAfterLogin.html"><div class="text" id="text2">Ikan Tongkol</div></a>
        </div>
      </div>
          
      <div class="onigiri" id="onigiri3">
        <a href="RAfterLogin.html"><img src="../assets/Rendang.png" alt=""></a>
        <div class="content" id="content3">  
          <a href="RAfterLogin.html"><div class="text" id="text3">Rendang</div></a>
        </div>
      </div>
            
      <div class="onigiri" id="onigiri4">
        <a href="ASAfterLogin.html"><img src="../assets/AyamSuwir.png" alt=""></a>
        <div class="content" id="content4">
          <a href="ASAfterLogin.html"><div class="text" id="text4">Ayam Suwir</div></a>
        </div>
      </div>
    </div> 
    </div>
